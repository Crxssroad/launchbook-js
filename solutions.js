...
let pagesClass = document.getElementsByClassName('pages')[0];
let groupsClass = document.getElementsByClassName('groups')[0];
...
document.getElementsByClassName('ad-slot')[0].getElementsByTagName('img')[0].setAttribute('src', 'http://placebear.com/200/30');
// Exercise 8): Find Sam's post and change its text to something incredible.
document.getElementsByClassName('media-body')[4].innerText = 'something incredible.';
// Exercise 9): Find the first post and add the `.post-liked` class to it, and watch it turn blue.
documents.getElementsByClassName('media-body')[4].className += ' post-liked'
"media-body post-liked"
// Exercise 10: Find the second post and add the `.post-shared` class to the `li` containing the text Shared to watch it turn red.
document.getElementsByClassName('media-body')[2].className += ' post-shared';
